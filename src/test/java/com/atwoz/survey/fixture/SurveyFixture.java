...
import static com.atwoz.survey.fixture.SurveyCreateRequestFixture.연애고사_선택_질문_과목_두개씩_생성_요청;
...
public class SurveyFixture {
    ...
    public static Survey 연애고사_선택_질문_과목_두개씩() {
        return Survey.from(연애고사_선택_질문_과목_두개씩_생성_요청());
    }
