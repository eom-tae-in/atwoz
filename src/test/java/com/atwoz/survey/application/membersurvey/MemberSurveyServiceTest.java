...
import com.atwoz.survey.infrastructure.membersurvey.MemberSurveyFakeRepository;
...
class MemberSurveyServiceTest {
    ...
    void init() {
        ...
        memberSurveyRepository = new MemberSurveyFakeRepository();
        memberSurveyService = new MemberSurveyService(memberSurveyRepository, surveyRepository);
    }
    ...
    void 회원이_연애고사_과목을_응시한다() {
        ...
        // when & then
        assertDoesNotThrow(() -> memberSurveyService.submitSurvey(memberId, requests));
    }
