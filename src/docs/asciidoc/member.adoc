...
include::{snippets}/member-auth-controller-web-mvc-test/do_signup/http-request.adoc[]
include::{snippets}/member-auth-controller-web-mvc-test/do_signup/request-fields.adoc[]


==== 응답
include::{snippets}/member-auth-controller-web-mvc-test/do_signup/http-response.adoc[]
include::{snippets}/member-auth-controller-web-mvc-test/do_signup/request-fields.adoc[]
